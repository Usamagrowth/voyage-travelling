...
const GlobalHeader = ({headerTitle, headerLink}) => {
  ...
  <section>
      <section className="relative min-h-[70vh] md:min-h-[90vh] w-full overflow-hidden inset-0 min-w-full bg-cover bg-center bg-[url(https://turmet-react.vercel.app/assets/img/breadcrumb/breadcrumb.jpg)] mb-20">
      ...
      <div className="relative z-[2000] px-6 pt-6 md:pt-6">
        ...
        <div className="relative z-10 flex items-center justify-center h-full px-6 pt-16">
          <div className="text-white text-center">
            <h2 className="text-4xl md:text-[3.7rem] font-[800] mb-5">{headerTitle}</h2>
